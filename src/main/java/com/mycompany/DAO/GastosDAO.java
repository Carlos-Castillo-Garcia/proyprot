...
public class GastosDAO {
    ...
    /**
     * Es el metodo que te permite consultar la suma de todos los gastos 
     * @param id
     * @param conexion
     * @return
     * @throws SQLException
    ...
    /**
     * Es el metodo que te permite consultar la suma de gastos de agua de un casa 
     * @param id
     * @param conexion
     * @return
     * @throws SQLException
    ...
    /**
     * Es el metodo que te permite consultar la suma de gastos de la comunidad de un piso de la base de datos
     * @param id
     * @param conexion
     * @return
     * @throws SQLException
